...
hi      Normal            cterm=NONE     gui=NONE     ctermfg=8     guifg=#F2F2F2  ctermbg=0      guibg=#161616
...
hi      Directory         cterm=NONE     gui=NONE     ctermfg=8     guifg=#F2F2F2  ctermbg=NONE   guibg=NONE
...
hi      FoldColumn        cterm=NONE     gui=NONE     ctermfg=8     guifg=#F2F2F2  ctermbg=NONE   guibg=NONE
hi      Folded            cterm=NONE     gui=NONE     ctermfg=8     guifg=#F2F2F2  ctermbg=NONE   guibg=NONE
...
hi      SignColumn        cterm=NONE     gui=NONE     ctermfg=8     guifg=#F2F2F2  ctermbg=NONE   guibg=NONE
...
hi      xmlTagName        cterm=NONE     gui=NONE     ctermfg=8     guifg=#F2F2F2  ctermbg=NONE   guibg=NONE
hi      xmlEndTag         cterm=NONE     gui=NONE     ctermfg=8     guifg=#F2F2F2  ctermbg=NONE   guibg=NONE
hi      xmlNamespace      cterm=bold     gui=bold     ctermfg=8     guifg=#F2F2F2  ctermbg=NONE   guibg=NONE
hi      xmlAttrib         cterm=NONE     gui=NONE     ctermfg=8     guifg=#F2F2F2  ctermbg=NONE   guibg=NONE

hi      texSection        cterm=bold     gui=bold     ctermfg=2     guifg=#AADB0F  ctermbg=NONE   guibg=NONE
hi      texMathZoneX      cterm=NONE     gui=NONE     ctermfg=NONE  guifg=NONE     ctermbg=8      guibg=#F2F2F2
hi      texMathText       cterm=NONE     gui=NONE     ctermfg=NONE  guifg=NONE     ctermbg=8      guibg=#F2F2F2
hi      texMathSymbol     cterm=bold     gui=bold     ctermfg=NONE  guifg=NONE     ctermbg=8      guibg=#F2F2F2
hi      texMathOper       cterm=bold     gui=bold     ctermfg=2     guifg=#AADB0F  ctermbg=8      guibg=#F2F2F2
hi      texMathMatcher    cterm=NONE     gui=NONE     ctermfg=NONE  guifg=NONE     ctermbg=8      guibg=#F2F2F2
hi      texTypeStyle      cterm=bold     gui=bold     ctermfg=NONE  guifg=NONE     ctermbg=8      guibg=#F2F2F2
hi      texStatement      cterm=bold     gui=bold     ctermfg=NONE  guifg=NONE     ctermbg=NONE   guibg=NONE
hi      texGreek          cterm=NONE     gui=NONE     ctermfg=NONE  guifg=NONE     ctermbg=8      guibg=#F2F2F2
hi      texBeginEnd       cterm=NONE     gui=NONE     ctermfg=2     guifg=#AADB0F  ctermbg=NONE   guibg=NONE
hi      texSubscript      cterm=NONE     gui=NONE     ctermfg=NONE  guifg=NONE     ctermbg=8      guibg=#F2F2F2
hi      texSuperscript    cterm=NONE     gui=NONE     ctermfg=NONE  guifg=NONE     ctermbg=8      guibg=#F2F2F2
hi      texBeginEndName   cterm=NONE     gui=NONE     ctermfg=NONE  guifg=NONE     ctermbg=NONE   guibg=NONE
hi      Conceal           cterm=NONE     gui=NONE     ctermfg=NONE  guifg=NONE     ctermbg=8      guibg=#F2F2F2
